    ...
    <div className="text-[#1F1F1F] max-w-5xl mx-auto p-6">
      <div className="">
        <p className="bg-customPurple1 rounded-4xl font-mono text-justify">
           A l&apos;origine de SYN Production, une envie partagée : explorer les silences dans la partition de nos vies prestissimo. Comment renouveler notre rapport à la Culture ? 
